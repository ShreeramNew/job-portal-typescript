               ...
               <div className="border-2 border-gray-400 h-[100px] w-[100px] rounded-[100%] relative">
                  <div className=" w-full h-full overflow-hidden rounded-[100%]">
                     {loading.uploadLoading ? (
                        ...
                        <Image
                           src={isForEdit ? ProfileData.profile ?? "" : profilePicURL}
                           alt="profile"
                           width={600}
                           height={600}
                  ...
                  >
                     <div className=" w-[85%] md:w-[60%] h-[12vh] ">
                        ...
                        <Form.Item<FieldType>
                           ...
                           initialValue={isForEdit ? ProfileData.username : ""}
                        >
                     ...
                     <div className=" w-[85%] md:w-[60%] h-[16vh]">
                        ...
                        <Form.Item<FieldType>
                           ...
                           initialValue={isForEdit ? ProfileData.bio : ""}
                        >
                           <TextArea
                     ...
                     <div className=" w-[85%] md:w-[60%] h-[12vh] ">
                        ...
                        <Form.Item<FieldType>
                           ...
                           initialValue={isForEdit ? ProfileData.education : ""}
                        >
                        ...
                        <>
                           <div className=" w-[85%] md:w-[60%] h-[12vh] ">
                              ...
                              <Form.Item<FieldType>
                                 ...
                                 initialValue={isForEdit ? ProfileData.company : ""}
                              >
                           ...
                           <div className=" w-[85%] md:w-[60%] h-[12vh] border- border-red-900">
                              ...
                              <div className=" flex ">
                                 <Form.Item<FieldType>
                                    name="time"
                                    rules={[
                                       { required: true, message: "Please give company name!" },
                                    ]}
                                    initialValue={isForEdit ? ProfileData.time : 0}
                                 >
                                    <Input
                     ...
                     <div className=" w-[85%] md:w-[60%] h-[12vh] ">
                        ...
                        <Form.Item<FieldType>
                           ...
                           initialValue={isForEdit ? ProfileData.phone : ""}
                        >
                     ...
                     <div className=" w-[85%] md:w-[60%] h-[12vh] ">
                        ...
                        <Form.Item<FieldType>
                           ...
                           initialValue={isForEdit ? ProfileData.linkedin : ""}
                        >
                     ...
                     <div className=" w-[85%] md:w-[60%] h-[12vh] ">
                        ...
                        <Form.Item<FieldType>
                           ...
                           initialValue={isForEdit ? ProfileData.gitHub : ""}
                        >
